...
def is_blackjack(card_one, card_two):
    ...
    if ((card_one == 'A' and card_two != 'A') or (card_two == 'A' and card_one != 'A')) and (value_of_card(card_one) == 10 or value_of_card(card_two) == 10):
        return True
    else:
        return False
...
def can_double_down(card_one, card_two):
    ...
    """
    summed = value_of_card(card_one) + value_of_card(card_two)
    if summed == 9 or summed == 10 or summed == 11:
        return True
    else:
        return False
